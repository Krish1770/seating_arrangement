...
//        String[] arrayY = point2.split("_");
//
//        int diffOfAX = Math.abs(Integer.parseInt(arrayA[0]) - Integer.parseInt(arrayX[0])) + Math.abs(Integer.parseInt(arrayA[1]) - Integer.parseInt((arrayX[1])));
//
//        int diffOfAY = Math.abs(Integer.parseInt(arrayA[0]) - Integer.parseInt(arrayY[0])) + Math.abs(Integer.parseInt(arrayA[1]) - Integer.parseInt((arrayY[1])));
//
//        if (diffOfAX > diffOfAY) return point2;
//
//        else return point1;
